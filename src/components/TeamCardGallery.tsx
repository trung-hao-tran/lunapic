        ...
        <>
            ...
            <div className='grid grid-cols-1 gap-12 md:grid-cols-2 lg:gap-16'>
                {teamMembers.map((member, index) => {
                    const isLastOdd = teamMembers.length % 2 === 1 && index === teamMembers.length - 1;

                    return (
                        <div key={member.id} className={`flex flex-col ${isLastOdd ? 'md:col-span-2 md:mx-auto' : ''}`}>
                                    ...
                                    <div
                                        ...
                                        <div className='absolute inset-0 [filter:grayscale(70%)_brightness(100%)] transition-all duration-[750ms] group-hover:[filter:grayscale(0%)_brightness(110%)]'>
                                            <Image
                                                ...
                                                alt={member.name}
                                                fill
                                                sizes='(max-width: 768px) 100vw, 24.375rem'
