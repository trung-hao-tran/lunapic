...
export function ContactPageClient({ config }: ContactPageClientProps) {
    ...
    // Get form type from URL, default to 'work' if not specified or invalid
    const formParam = searchParams.get('form') as FormType | null;
    const initialForm: FormType = formParam === 'join' || formParam === 'work' ? formParam : 'work';
    ...
    // Function to switch forms and update URL
                    ...
                    <div className='grid grid-cols-1 gap-24 lg:grid-cols-[4fr_6fr]'>
                        ...
                        <div className='space-y-8'>
                            ...
                            <h2
                                ...
                                {parseHighlightedText(config.title).map((part, index) => {
                                    // Add line break before highlighted text
                                    if (part.props.style.color === '#FFF') {
                                        return (
